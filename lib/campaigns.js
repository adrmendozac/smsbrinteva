...
CONTENT:
- Start with "Brinteva Worlds:" so the sender is identified.
- One offer, one call to action. The booking line is call-only: "Llama al (925) 665-8003".
- Warm and direct; use "tu", not "usted". No hype-caps, no exclamation chains.
- End with "Responde STOP para cancelar" when it fits.
