...
function registerWebhookRoutes(app, deps) {
  const { db, axios, env, sendSMS, mirrorInboundToKommo, mirrorOutboundToKommo, pushKommoDeliveryStatus, sendKommoTyping, createSmsLead } = deps;
  ...
  app.post('/inbound', async (req, res) => {
    ...
    try {
      ...
      if (isNewConversation && createSmsLead) {
        createSmsLead({ phone: msisdn, name: null, text }).catch(() => {});
      }
