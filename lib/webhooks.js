...
function registerWebhookRoutes(app, deps) {
  const { db, axios, env, sendSMS, mirrorInboundToKommo, mirrorOutboundToKommo, pushKommoDeliveryStatus, sendKommoTyping, createSmsLead, createLeadNote, addLeadTags } = deps;
