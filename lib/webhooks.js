...
function registerWebhookRoutes(app, deps) {
  const { db, axios, env, log, sendSMS, mirrorInboundToKommo, mirrorOutboundToKommo, pushKommoDeliveryStatus, sendKommoTyping, createSmsLead, createLeadNote, addLeadTags } = deps;
