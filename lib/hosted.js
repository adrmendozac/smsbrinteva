...
// Claude Haiku 4.5 standard API list prices (USD, August 2026). The
...
function estimateHaikuCost(inputTokens, outputTokens) {
  ...
  return Number(((input * HAIKU_INPUT_USD_PER_MILLION + output * HAIKU_OUTPUT_USD_PER_MILLION) / 1_000_000).toFixed(6));
}
...
async function analyzeHostedBody(deps, text, explicitTitle = null) {
  ...
  const estimatedCostUsd = inputTokens === null || outputTokens === null
    ? null
    : estimateHaikuCost(inputTokens, outputTokens);
